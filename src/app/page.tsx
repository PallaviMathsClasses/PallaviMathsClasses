    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-2xl mx-auto px-5 pt-12 pb-16">
          ...
          <div className="flex items-center gap-3 mb-10">
            ...
            <div>
              ...
              <div className="text-lg font-bold text-gray-900 leading-tight">Pallavi Maths Classes</div>
            </div>
          </div>
        ...
        <div className="max-w-2xl mx-auto px-5">
          ...
          <div className="card">
            <div className="flex gap-3 mb-4">
              ...
              <div>
                <div className="font-semibold text-gray-900">Pallavi Maths Classes</div>
      ...
      <footer className="border-t border-gray-100 py-8">
        <div className="max-w-2xl mx-auto px-5 text-center">
          <div className="font-semibold text-gray-900 mb-1">Pallavi Maths Classes</div>
